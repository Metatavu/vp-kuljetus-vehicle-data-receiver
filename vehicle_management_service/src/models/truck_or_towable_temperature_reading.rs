...
/// TruckOrTowableTemperatureReading : Represents a single truck or towable temperature reading being received from a thermometer
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TruckOrTowableTemperatureReading {
...
impl TruckOrTowableTemperatureReading {
    /// Represents a single truck or towable temperature reading being received from a thermometer
    pub fn new(device_identifier: String, hardware_sensor_id: String, value: f32, timestamp: i64, source_type: models::TemperatureReadingSourceType) -> TruckOrTowableTemperatureReading {
