...
/// TruckOrTowableThermometer : Represents a thermometer attached to a truck or towable
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TruckOrTowableThermometer {
...
impl TruckOrTowableThermometer {
    /// Represents a thermometer attached to a truck or towable
    pub fn new(mac_address: String, entity_id: uuid::Uuid, entity_type: EntityType) -> TruckOrTowableThermometer {
