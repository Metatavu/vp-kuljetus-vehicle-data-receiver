...
/**You should use this struct via [`VehicleManagementServiceClient::create_truck`].
...
impl FluentRequest<'_, CreateTruckRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateTruckRequest> {
