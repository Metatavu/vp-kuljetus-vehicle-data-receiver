...
/**You should use this struct via [`VehicleManagementServiceClient::update_towable`].

On request success, this will return a [`Towable`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateTowableRequest {
...
impl UpdateTowableRequest {}
pub struct UpdateTowableRequired<'a> {
    pub plate_number: &'a str,
    pub towable_id: &'a str,
    pub type_: &'a str,
    pub vin: &'a str,
}
impl<'a> UpdateTowableRequired<'a> {}
impl FluentRequest<'_, UpdateTowableRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, UpdateTowableRequest> {
