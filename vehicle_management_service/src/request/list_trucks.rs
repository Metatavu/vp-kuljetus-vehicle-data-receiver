...
/**You should use this struct via [`VehicleManagementServiceClient::list_trucks`].

On request success, this will return a [`Vec<Truck>`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ListTrucksRequest {
    pub archived: Option<bool>,
    pub first: Option<i64>,
    pub max: Option<i64>,
    pub plate_number: Option<String>,
}
impl ListTrucksRequest {}
impl FluentRequest<'_, ListTrucksRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, ListTrucksRequest> {
    type Output = httpclient::InMemoryResult<Vec<Truck>>;
